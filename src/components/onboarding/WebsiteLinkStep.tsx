    ...
    <div className="text-center">
      ...
      <div className="relative">
        <div className="absolute -top-16 -right-4 w-24 h-24 flex items-center justify-center animate-float opacity-30 pointer-events-none">
          <Globe className="h-full w-full text-brand-coral" />
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="max-w-md mx-auto">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input
                ...
                className="pl-10 bg-background/50 border-input focus:border-brand-teal focus:ring-2 focus:ring-brand-teal/20 transition-all"
              />
        ...
        <Button 
          type="submit"
          className="mt-8 gradient-bg hover:opacity-90"
        >
